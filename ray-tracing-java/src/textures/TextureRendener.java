...
//        HitableList world = new HitableList(this.random_scene());
    ...
    public ArrayList<Hitable> two_spheres()
    {
        ...
        objList.add(new Sphere(new Vec3(0.0f,-1000f,0.0f), 999.2f, new Metal(
                new ConstantTexture(new Vec3(0.4f,0.4f,0.4f)),0f)));
        objList.add(new Sphere(new Vec3(0.0f,0.0f,0.0f), 0.5f, new Lambertian( new ImageTexture("alone.png"))));
        objList.add(new Sphere(new Vec3(2.0f,0.0f,-1.0f), 0.5f, new Lambertian(new ImageTexture("raid.png"))));
        objList.add(new Sphere(new Vec3(4.0f,1.0f,1.0f), 0.5f, new Lambertian(new ImageTexture("end.png"))));
        objList.add(new Sphere(new Vec3(6.0f,2.0f,-1.0f), 0.5f, new Lambertian(new ImageTexture("debut.png"))));
        objList.add(new Sphere(new Vec3(-2.0f,0.0f,1.0f), 0.5f, new Lambertian(new ImageTexture("fall.png"))));
        objList.add(new Sphere(new Vec3(-4.0f,2.0f,-1.0f), 0.5f, new Lambertian(new ImageTexture("prequel.png"))));
        objList.add(new Sphere(new Vec3(-6.0f,1.0f,1.0f), 0.5f, new Lambertian(new ImageTexture("escape.png"))));
        return  objList;
    }
